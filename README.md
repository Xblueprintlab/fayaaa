...
<p align="center">
  ...
  A shape-aware WebGPU shader playground that runs entirely in the browser.<br />
  <a href="https://blueprintlab.work/fayaaa/"><strong>Open the live playground →</strong></a>
</p>
...
Fayaaa uses anonymous product analytics that never include uploaded media, filenames,
entered text, or raw URLs.
...
- Source comparison, pause, sound, automatic intro, and reduced-motion support
- Flattened PNG export
- MP4 or WebM video export at 16:9, 1:1, 4:5, or 9:16; 3, 5, or 10 seconds at 24, 30, or 60 FPS
...
Open [http://localhost:5173/fayaaa/](http://localhost:5173/fayaaa/).
